...
"""
def two_mapper(mapper_figure_dict : dict, fancy_simplices = False, fancy_edges = False):
    # Some validation for the mapper_figure_dictionary.
    # We require the layout_dim = 3, and layout default is kamada-kawaii-3d.
    ...
    if 'layout' not in mapper_figure_dict:
        mapper_figure_dict['layout'] = 'kk3d'
